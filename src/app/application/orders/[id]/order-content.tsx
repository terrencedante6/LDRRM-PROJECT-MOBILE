...
import { DataTable as FoodSupplyRequests } from "./order-service-tables/product-orders/data-table";
import { DataTable as EquipmentRequests } from "./order-service-tables/part-orders/data-table";
import { DataTable as VehicleRequests } from "./order-service-tables/service-orders/data-table";

import { initiateColumns as initiateFoodSuppliesRequestsColumns } from "./order-service-tables/product-orders/columns";
import { initiateColumns as initiateEquipmentsRequestsColumns } from "./order-service-tables/part-orders/columns";
import { initiateColumns as initiateVehicleRequestsColumns } from "./order-service-tables/service-orders/columns";
        ...
        return (
          <div className="w-full h-fit bg-darkComponentBg rounded-2xl p-4 shadow-xl flex flex-col gap-2 active:scale-95 transition-all duration-300">
            ...
            <div className="w-full flex gap-3">
              <Avatar className="w-20 h-20 cursor-pointer rounded-lg shadow-2xl primary-glow transition-all duration-300 brequest-2 brequest-applicationPrimary hover:brequest-applicationPrimary">
                <AvatarImage
            ...
            <div className="w-full flex flex-col place-items-center gap-1">
              ...
              {/* <div className="w-full flex flex-col gap-2 ">
                {request._entries.length > 1 ? (
                  request._entries.map((Data: any, i: number) => (
                    <div className="w-full flex gap-2 p-2 rounded-2xl bg-lightBorder">
                      ...
                      >
                        ...
                        />
                        <AvatarFallback className="bg-lightComponentBg text-xs rounded-md">{`${Data..first_name[0]}${Data..last_name[0]}`}</AvatarFallback>
                      </Avatar>
                      <div className="w-full flex flex-col">
                  ...
                  <div className="flex place-items-center gap-2">
                    <Avatar className={cn(`border-2 border-darkComponentBg`)}>
                      <AvatarImage
                        src={request._entries[0]..image_url}
                        className="rounded-md"
                      />
                      <AvatarFallback className="bg-lightComponentBg text-xs">{`${request._entries[0]..first_name[0]}${request._entries[0]..last_name[0]}`}</AvatarFallback>
                    </Avatar>
                  </div>
                )}
              </div> */}
              ...
              <div className="w-full z-10">
                ...
                >
                  ...
                  <AccordionItem value="item-2">
                    ...
                    <AccordionContent className="rounded-xl">
                      <FoodSupplyRequests
                        columns={initiateFoodSuppliesRequestsColumns()}
                        data={request.use_foodsupplies}
                      />
                    </AccordionContent>
                  </AccordionItem>
                  <AccordionItem value="item-3">
                    <AccordionTrigger className="sticky top-0">
                      <span className="flex place-items-center gap-3 font-regular text-white">
                        ...
                        Parts
                        <span className="text-xs bg-applicationPrimary px-3 rounded-full">
                          {request.use_equipments.length}
                        </span>
                      </span>
                    </AccordionTrigger>
                    <AccordionContent className="bg-darkComponentBg rounded-xl">
                      <EquipmentRequests
                        columns={initiateEquipmentsRequestsColumns()}
                        data={request.use_equipments}
                      />
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
