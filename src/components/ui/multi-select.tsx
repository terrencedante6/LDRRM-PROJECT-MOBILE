      ...
      <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            className="flex w-full rounded-md border border-slate-600/50 min-h-9 h-auto items-center justify-between hover:bg-lightComponentBg hover:text-black group px-2 bg-white"
          >
        ...
        <PopoverContent
          className="w-[300px] p-0 border border-slate-600/50 rounded-lg bg-white text-black shadow-xl"
          align="start"
          ...
          <Command className="bg-lightComponentBg">
            ...
            <CommandList>
              <ScrollArea className="h-40 2xl:h-72 w-full relative">
                <CommandEmpty>No rescuers found.</CommandEmpty>
                <CommandGroup>
                  {options.map((option) => {
        ...
        {animation > 0 && selectedValues.length > 0 && (
          <Sparkles
            className={cn(
              "cursor-pointer my-2 text-black bg-white w-3 h-3",
